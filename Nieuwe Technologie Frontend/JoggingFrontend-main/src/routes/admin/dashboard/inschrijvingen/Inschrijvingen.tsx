...
interface InschrijvingenProps {
	competitionId: number;
	competition: Competition;
}

const Inschrijvingen: React.FC<InschrijvingenProps> = ({
	competitionId,
	competition,
}) => {
		...
		<div className='relative'>
			<Card>
				<CardHeader className='relative'>
					...
					<CardDescription>
						Bewerk of verwijder inschrijvingen voor een wedstrijd hier.
					</CardDescription>
					<TooltipProvider>
						<Tooltip>
							<TooltipTrigger
								asChild
								className='absolute right-5 top-1 md:top-3'
							>
